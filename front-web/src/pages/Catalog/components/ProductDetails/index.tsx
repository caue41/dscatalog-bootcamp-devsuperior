            ...
            <div className="card-base border-radius-20 product-details">
                ...
                <div className="row">
                    ...
                    <div className="col-6 product-details-card">
                        ...
                        aplicativos simultâneos na tela. A tela está ficando abarrotada? Crie 
                        áreas de trabalho virtuais para obter mais espaço e trabalhar com os itens que você 
                        deseja. Além disso, todas as notificações e principais configurações são reunidas 
