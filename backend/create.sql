...
create table tb_product (id int8 generated by default as identity, date TIMESTAMP WITH TIME ZONE, description TEXT, img_url varchar(255), name varchar(255), price float8, primary key (id));
